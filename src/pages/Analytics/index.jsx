    ...
    <>
      {farmId !== null ? (
        <div className="pt-14 px-[30px]">
          ...
          <p className="text-[#041300] text-[32px] font-medium mb-6">
            Analytics
          </p>
        ...
        <div className=" text-2xl text-center  h-screen flex items-center justify-center flex-col">
          <h2>
            Pleace Select Farm
            <CustomeButton
              to="/allfarms"
              text="Select Farm"
              className="bg-[#F3F7F3] shadow-none text-base text-primary"
            />
          </h2>
        </div>
      )}
