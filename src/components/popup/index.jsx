    ...
    >
      <div className="bg-white rounded-[20px] shadow-3xl  pb-[41px] pt-6 px-8 w-[380px]">
        <form action="" className="relative">
          <div className="flex  items-center mb-4 py-3 ps-4 relative border border-[#EAECF0] rounded-xl  ">
            <img src={calander} alt="calendar" className="-mt-1" />
            <span className="ms-2 bg-transparnt whitespace-nowrap text-[#999999] text-base font-normal">
              {date}
            </span>
            <input
              type="date"
