...
function CostBreakdown() {
  ...
  return (
    <div
      className="rounded-[20px] shadow-3xl pt-3 pb-4 flex flex-col items-center md:px-[30px] relative"
      style={{
        background: ` linear-gradient(33deg, #006263 -12.71%, rgba(3, 101, 100, 0.70) 100%, rgba(0, 103, 102, 0.70) 100%)`,
      }}
    >
